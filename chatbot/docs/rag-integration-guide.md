...
- **Official LINE Rich Menu (ขนาดมาตรฐาน 2500x1686 - Custom Artwork):**
  ...
  - ระบบประมวลผลภาพอัตโนมัติ: บันทึกและ Optimize ไฟล์ `rich_menu_line.jpg` (2500x1686 px, ขนาด ~486 KB) สำหรับส่งขึ้น LINE CDN ทันที
- **Contextual Quick Reply Chips (ปุ่มตอบกลับด่วนอัจฉริยะ):**
  - ตรวจจับบริบทแล้วสลับปุ่มให้ผู้ใช้กดถามต่อได้ทันทีสูงสุด 12 ปุ่ม ครอบคลุมทั้ง 5 หมวดหมู่
...
- **Stunning Flex Message Carousel (8 เมนูเครื่องดื่มมาตรฐานจากคู่มือ):**
  - การ์ดสไลด์แนวนอนขนาด Mega พร้อม Color Palette เฉพาะเมนู, ป้าย Badge `📋 เมนูมาตรฐาน`, ตารางพารามิเตอร์ (สัดส่วน, เวลา/อุณหภูมิ, มาตรฐาน), กล่องเคล็ดลับบาริสต้า (Barista Tips) และปุ่ม Dual Actions:
    1. `📖 ดูวิธีทำ SOP`
    2. `⚙️ พารามิเตอร์การสกัด`
  - ครอบคลุมทั้ง 8 เมนูหลัก: เอสเพรสโซ่ เพอร์เฟกต์ช็อต, อเมริกาโน่ร้อน, อเมริกาโน่เย็น, เอสเพรสโซ่เย็นสไตล์ไทย, กาแฟส้ม, กาแฟพีช, ลาเต้มิ้นท์, กาแฟน้ำผึ้งมะนาว
- **Extraction Troubleshoot Flex Card:**
  - การ์ดเปรียบเทียบข้อผิดพลาดการสกัด 4 สถานะ: Under-Extraction (สีแดง), Over-Extraction (สีส้ม), Channeling (สีเหลือง), และ Perfect Shot (สีเขียว) พร้อมแนวทางแก้ไขทันที
...
- 📊 [สไลด์สรุปสำหรับการนำเสนอ (Presentation Slide Deck)](file:///d:/PIK/y4-1/241-351_AI_for_social/chongpenyang/chatbot/docs/presentation-slide-deck.md)
- 🏆 [รายงานตรวจสอบเกณฑ์รูบิกประเมินผล RAG (100% เกรด A)](file:///d:/PIK/y4-1/241-351_AI_for_social/chongpenyang/chatbot/docs/rubric-evaluation-checklist.md)
