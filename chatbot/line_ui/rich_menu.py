...
BARISTA_MENU_ITEMS = [
    ...
    {
        "title": "เมล็ด & การคั่ว",
        "sub": "สายพันธุ์, Agtron, 5 เบอร์บด",
        "icon": "🌱",
        "bg": "#2C1810",
        "accent": "#D4A373",
        "text": "ความรู้เรื่องเมล็ดกาแฟ สายพันธุ์ ระดับการคั่ว Agtron และเบอร์บด"
    },
    {
        "title": "สกัด Perfect Shot",
        "sub": "9-10 บาร์, 90-96°C, 20-30s",
        "icon": "☕",
        "bg": "#3E2723",
        "accent": "#E6CCB2",
    ...
    },
    {
        ...
        "sub": "แบบทดสอบ, Checklist, เฉลย",
        "icon": "📝",
        "bg": "#3E2723",
        "accent": "#E6CCB2",
        "text": "แบบทดสอบวัดระดับความรู้บาริสต้าในคู่มือมีอะไรบ้าง?"
    }
]
